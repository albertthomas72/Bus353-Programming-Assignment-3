...
// in simulator we redefine to format for Map Developer console
...
{\
	NSString * exceptionName = [@"org.map." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.map";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMapNativeItemNone = -1, 
	UIMapNativeItemSpinner = -2,
	UIMapNativeItemProgressBar = -3,
	
	UIMapNativeItemSlider = -4,
	UIMapNativeItemSwitch = -5,
	UIMapNativeItemMultiButton = -6,
	UIMapNativeItemSegmented = -7,
	
	UIMapNativeItemTextView = -8,
	UIMapNativeItemTextField = -9,
	UIMapNativeItemSearchBar = -10,
	
	UIMapNativeItemPicker = -11,
	UIMapNativeItemDatePicker = -12,
	
	UIMapNativeItemInfoLight = -13,
	UIMapNativeItemInfoDark = -14,
	
	UIMapNativeItemDisclosure = -15,
	
	UIMapNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Map instances of
